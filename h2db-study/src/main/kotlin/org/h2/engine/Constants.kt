...
object Constants {
     ...
     */
    const val INITIAL_LOCK_TIMEOUT = 2000
     ...
     */
    const val MAX_NUMERIC_PRECISION = 100000

    /**
     * The maximum allowed cardinality of array.
     */
    const val MAX_ARRAY_CARDINALITY = 65536

    /**
     * The highest possible parameter index.
     */
    const val MAX_PARAMETER_INDEX = 100000
    ...
    // Java 6, 64 bit: 24
    // Java 6, 32 bit: 12
    const val MEMORY_OBJECT = 24

    /**
     * The memory needed by an array.
     */
    const val MEMORY_ARRAY = 24
     ...
     */
    const val VERSION_STABLE = "1.4.$BUILD_ID_STABLE"
